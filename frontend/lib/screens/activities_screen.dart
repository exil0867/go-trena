  ...
  Widget build(BuildContext context) {
    ...
    return GlobalScaffold(
      ...
      body: FutureBuilder<List<dynamic>?>(
        future: apiService.getUserActivities(activity.id),
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (_) => PlansScreen(
                          apiService: apiService, activity: activity),
                    ),
                  );
                },
              );
      ...
      //         context,
      //         MaterialPageRoute(
      //             builder: (_) => AddActivityScreen(apiService: apiService)));
      //   },
...
class AddActivityScreen extends StatelessWidget {
  ...
  AddActivityScreen({required this.apiService, super.key});

  void _addActivity(BuildContext context) async {
    final activityData = {
      'name': activityController.text /*, add other fields if needed */
    };
